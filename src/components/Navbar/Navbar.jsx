...
export const Navbar = () => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 right-0 backdrop-blur-sm shadow-sm bg-white/90 border border-gray-100">
      <div className="container w-full flex justify-between items-center gap-4 h-16 md:h-20 px-8 md:px-4">
        {/* Logos */}
